		...
		<view class="control">
			<view class="slider">
				...
				<slider class="player-slider" activeColor="rgb(248, 78, 81)" block-size="8"
					:value="playerStore.position" :max="playerStore.duration" @change="seek"></slider>
		...
		<uni-popup ref="popup" @change="change">
			<view class="popup-content">
				<view class="header">
					...
					<uni-icons class="close-btn" type="down" size="25" @click="closeList"></uni-icons>
				</view>
				<scroll-view class="popup-scroll">
					<view hover-class="click-hover" hover-stay-time="50" class="song" v-for="(item,index) in playerStore.playlistModel" :key="index">
