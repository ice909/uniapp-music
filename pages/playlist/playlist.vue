<template>
	<view>
		<uni-nav-bar statusBar @clickLeft="back" v-if="loading" :title="playlistInfo.name" left-icon="left"
		...
		<view v-if="loading" class="content">
			<view class="header">
				...
				<view class="playlist-info">
					...
					<view class="creator">
						...
						<text class="create-date">创建于{{ formatDate(playlistInfo.createTime) }}</text>
					</view>
			...
			<SongList style="margin-top: 5px" :songs="songs" :playlist-id="playlistInfo.id" :pageNumber="pageNumber"
				:loadSize="loadSize" />
			<uni-pagination style="margin-top: 10px" v-model="pageNumber" :pageSize="loadSize" :total="count" />
		</view>
